...
const (
	...
	InboxMessage_TODO_REMINDER InboxMessage_Type = 2
)
...
type InboxMessage struct {
	...
	// The UID of the related todo for reminder notifications.
	TodoUid       *string `protobuf:"bytes,3,opt,name=todo_uid,json=todoUid,proto3,oneof" json:"todo_uid,omitempty"`
...
func (x *InboxMessage) GetTodoUid() string {
	if x != nil && x.TodoUid != nil {
		return *x.TodoUid
	}
	return ""
}
...
const file_store_inbox_proto_rawDesc = "" +
	"\n" +
	"\x11store/inbox.proto\x12\vmemos.store\"\xe8\x01\n" +
	"\fInboxMessage\x122\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1e.memos.store.InboxMessage.TypeR\x04type\x12$\n" +
	"\vactivity_id\x18\x02 \x01(\x05H\x00R\n" +
	"activityId\x88\x01\x01\x12\x1e\n" +
	"\btodo_uid\x18\x03 \x01(\tH\x01R\atodoUid\x88\x01\x01\"A\n" +
	"\x04Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\x10\n" +
	"\fMEMO_COMMENT\x10\x01\x12\x11\n" +
	"\rTODO_REMINDER\x10\x02B\x0e\n" +
	"\f_activity_idB\v\n" +
	"\t_todo_uidB\x95\x01\n" +
	"\x0fcom.memos.storeB\n" +
