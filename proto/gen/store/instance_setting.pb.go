...
func (x *InstanceSetting) GetTodoSetting() *InstanceTodoSetting {
	if x != nil {
		if x, ok := x.Value.(*InstanceSetting_TodoSetting); ok {
...
type InstanceTodoSetting struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *InstanceTodoSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}
