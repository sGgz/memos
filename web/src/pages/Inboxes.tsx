...
import TodoReminderMessage from "@/components/Inbox/TodoReminderMessage";
            ...
            {notifications.length === 0 ? (
              ...
              <div className="flex flex-col">
                {notifications.map((notification: UserNotification) => {
                  ...
                  if (notification.type === UserNotification_Type.TODO_REMINDER) {
                    return <TodoReminderMessage key={notification.name} notification={notification} />;
                  }
                  return null;
                })}
              </div>
