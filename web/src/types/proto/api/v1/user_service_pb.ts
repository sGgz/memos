...
export type UserNotification = Message<"memos.api.v1.UserNotification"> & {
   ...
   * Format: todos/{todo}
   *
   * @generated from field: optional string todo_name = 7;
   */
  todoName?: string;
};
...
export enum UserNotification_Type {
  ...
  /**
   * @generated from enum value: TODO_REMINDER = 2;
   */
  TODO_REMINDER = 2,
}
