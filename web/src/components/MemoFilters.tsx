      ...
      {filters.map((filter) => {
        ...
        return (
          <div
            ...
            className="group inline-flex items-center gap-2 h-8 px-3 bg-gradient-to-r from-secondary/80 via-secondary/50 to-secondary/80 border border-border/60 text-xs uppercase tracking-[0.18em] text-muted-foreground transition-all duration-300 hover:border-primary/40 hover:text-foreground hover:shadow-[0_10px_30px_rgba(0,0,0,0.2)]"
          >
