...
const StatisticsView = (props: Props) => {
  ...
  return (
    <div className="group w-full mt-2 flex flex-col text-muted-foreground animate-fade-in border border-sidebar-border/80 bg-card/70 px-3 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.4)]">
