...
const MemoCardSkeleton = ({ showCreator, index }: { showCreator?: boolean; index: number }) => (
  <div className="relative flex flex-col bg-gradient-to-br from-card/80 via-card/60 to-card/80 w-full px-5 py-4 mb-4 gap-3 border border-border/50 shadow-[0_30px_60px_rgba(0,0,0,0.2)] backdrop-blur-xl">
